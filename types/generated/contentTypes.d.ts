...
export interface ApiAuthorizedUserAuthorizedUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    mai_id: Attribute.String;
    login: Attribute.String;
    device: Attribute.String;
    no_dog: Attribute.String;
    passw: Attribute.String;
    ip: Attribute.String;
    useragent: Attribute.String;
    datesess: Attribute.DateTime;
...
export interface ApiBlockedUserBlockedUser extends Schema.CollectionType {
